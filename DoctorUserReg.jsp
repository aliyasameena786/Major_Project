    ...
    <div id="topnav">
      <ul>
       ...
       <li><a href="Cloud.jsp">Server</a></li>
        <li class="active"><a href="Doctor.jsp">Doctor</a></li>
...
<div class="wrapper col3" style="margin-bottom:100px;">
  <div id="container">
    ...
    <div class="homepage">
         <form action='DoctorRegAction' method='post'>
                <table>
                    ...
                    <tr><th>Gender</th><td><select name="gender" required="">
                                <option></option>
                                            <option value="male">Male</option>
                                            <option value="female">FeMale</option>
                            </select></td><tr/>
                     
                    <tr><th>Hospital</th><td><input type='text' name='hospital' required='' placeholder="Hospital"></td><tr/>
                <tr><th>Specialization</th><td><select name="specialization" required="">
                                <option></option>
                    ...
                    <td><a href='Doctor.jsp'>Login</a></td><tr/>
                </table>
            </form>   
      <br class="clear" />
    </div>
